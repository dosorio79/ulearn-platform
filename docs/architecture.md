...
- Frontend (React + Vite + Tailwind) renders the lesson UI using a mocked API client that follows `openapi.yaml`.
...
- `frontend/src/api/lessonClient.ts`: Mocked API client.
